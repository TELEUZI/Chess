import { Coordinate } from 'packages/coordinate/src/lib/coordinate';
import { FigureColor } from 'packages/game-common/src/lib/player';
import { FigureType } from 'packages/game-common/src/lib/interfaces';
import { FieldState } from '../../field-state';
import { FigureModel } from '../../figures/figure-model';
import { CellModel } from '../../models/cell-model';
import { exchangePositions } from './field-service';
...
describe('exchangePositions', () => {
  ...
  //   const state = new FieldState([
  //     [
  //       new CellModel(new FigureModel(FigureColor.WHITE, FigureType.PAWN)),
  //       new CellModel(new FigureModel(FigureColor.WHITE, FigureType.PAWN)),
  //     ],
  //     [new CellModel(null), new CellModel(new FigureModel(FigureColor.BLACK, FigureType.PAWN))],
  //   ]);

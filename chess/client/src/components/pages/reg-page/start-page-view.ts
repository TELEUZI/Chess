...
export default class StartPageView extends BaseComponent {
  ...
  constructor() {
    ...
    this.startButton = new Button('Play offline', () => this.onStartSingleGame());
    this.gameModeButton = new Button('Play online', () => this.onStartMultiplayerGame());
    this.startGameWithBot = new Button('Play with computer', () => this.onStartGameWithBot());
